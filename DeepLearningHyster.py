...
import pickle
import numpy as np
from create_hyster_feature_sets import create_feature_sets_and_labels
train_x, train_y, test_x, test_y = create_feature_sets_and_labels('new_training1.dat')
#= pickle.load('hyster_set.pickle', 'rb')
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(n_epochs):
            ...
            while i < len(train_x):
                ...
                epoch_loss += c
                i += batch_size
            print('Epoch', epoch + 1, 'completed from', n_epochs, ' loss:', epoch_loss)
